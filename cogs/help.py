...
class HomeButton(discord.ui.View):
  ...
  @discord.ui.button(label="查看main", style=discord.ButtonStyle.primary)
  ...
  @discord.ui.button(label="查看role", style=discord.ButtonStyle.primary)
  ...
  @discord.ui.button(label="查看task", style=discord.ButtonStyle.primary)
